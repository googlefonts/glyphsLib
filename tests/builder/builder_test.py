...
class ToUfosTest(unittest.TestCase):
    ...
    def test_load_kerning(self):
        ...
        Correct resolution is defined as such: the last time a pair is
        found in a kerning rule, that rule is used for the pair.
        """
...
class GlyphOrderTest(unittest.TestCase):
    ...
    def test_from_ufo_partial_public_order_no_custom_order(self):
        ...
        public.glyphOrder, we could not know how to order them like
        Glyphs.app
        """
